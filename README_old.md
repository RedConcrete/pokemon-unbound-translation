...
Der Fortschritts-Badge in `README.md` wird automatisch aktualisiert, wenn `inject_text.py` erfolgreich eine GBA schreibt.
...
Der `Deutsch`-Fortschritts-Badge oben wird beim erfolgreichen Build automatisch erneuert.
